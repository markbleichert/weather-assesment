...
/***/ function(module, exports, __webpack_require__) {
	...
	var DATA = __webpack_require__(158);
	//var localStorage = require('./LocalStorage'); @todo: use this class

	var SearchBox = __webpack_require__(159);
	var Forecast = __webpack_require__(171);
	var Map = __webpack_require__(167);
	var CurrentLocation = __webpack_require__(168);
	var LocationList = __webpack_require__(169);
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: "col-md-12" },
						React.createElement(CurrentLocation, { location: this.state.location,
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: "col-md-3" },
						React.createElement(SearchBox, { onSearch: this.searchForAddress, label: 'Locations', data: listItems }),
						React.createElement(LocationList, { locations: this.state.favorites, activeLocation: this.state.location,
							onClick: this.searchForAddress })
					),
					React.createElement(
						'div',
						{ className: "col-md-9" },
						React.createElement(Forecast, { locations: locations }),
						React.createElement('br', null),
						React.createElement(
							'div',
							{ className: "col-md-8" },
							React.createElement(Map, { coords: this.state.location.coords })
						)
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSelect = __webpack_require__(160);
	...
	var SearchBox = _react2['default'].createClass({
		...
		render: function render() {
			return _react2['default'].createElement(
				'div',
				{ id: 'find-a-forecast', className: 'section' },
				_react2['default'].createElement(
					'h2',
					null,
					'Find a forecast'
				),
				_react2['default'].createElement(_reactSelect2['default'], { ref: 'stateSelect', options: this.props.data, searchable: this.state.searchable, disabled: this.state.disabled, value: this.state.selectValue, onChange: this.updateValue })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Input = __webpack_require__(161);
	var classes = __webpack_require__(162);
	var Value = __webpack_require__(163);
	var SingleValue = __webpack_require__(164);
	var Option = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var LocationItem = __webpack_require__(170);
	...
	var LocationList = React.createClass({
		...
		render: function render() {
			...
			var locations = this.props.locations.map(function (l) {
				...
				return React.createElement(LocationItem, { location: l.location, timestamp: l.timestamp,
			...
			return React.createElement(
				'div',
				{ className: 'col-xs-12 col-md-offset-0' },
				React.createElement(
					'span',
	...
	var Weather = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement('span', { className: imageClassName }),
				React.createElement(
					'span',
					{ className: "daily-temp" },
					this.props.location.temperature_max
				),
				React.createElement(
					'span',
					{ className: "daily-temp min" },
					this.props.location.temperature_min
				),
				React.createElement(
					'span',
					{ className: "daily-rain" },
					'Rain ',
					this.props.location.precipitation_probability,
					' %'
				)
			);
		}
		...
		render: function render() {
			...
			var rows = this.props.locations.map(function (location) {
				...
				if (location.station_id !== lastId) {
					return React.createElement(Weather, { active: active, location: location, key: id++ });
				}
			});

			return React.createElement(
				'div',
				{ className: "tabbed-forecast" },
				React.createElement(
					'ul',
					{ className: "daily" },
					rows
